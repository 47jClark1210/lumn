  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', marginBottom: 32 }}>
      <Card
        ...
        style={{ marginBottom: 32, boxShadow: '0 2px 16px rgba(0,0,0,0.10)', borderRadius: 18, border: 'none', padding: 0 }}
        bodyStyle={{ padding: 0 }}
      >
        <List
...
function Learning() {
  // ...existing code...
  // Place leaderboard above modules
  return (
    <div>
      <h2>Learning & Development</h2>
      <Leaderboard />
      {/* ...existing module management code... */}
      {/* Place the rest of the previous Learning page code here, unchanged */}
      {/* ...existing code... */}
    </div>
  );
}
